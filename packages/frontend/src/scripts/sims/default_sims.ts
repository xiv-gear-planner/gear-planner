...
import {getRegisteredSimSpecs, registerSim} from "@xivgear/core/sims/sim_registry";
...
import { VprSimGui } from "./melee/vpr/vpr_sheet_sim_gui";
...
function registerGui<X extends Simulation<SimResult, unknown, unknown>>(simSpec: SimSpec<X, any>, guiCtor: SimGuiCtor<X>) {
...
export function makeGui<X extends Simulation<any, any, any>>(sim: X): SimulationGui<ResultTypeOfSim<X>, SettingsTypeOfSim<X>, ExportSettingsTypeOfSim<X>> {
