...
describe("ComputedSetStats", () => {
    ...
    it('computes correctly with no food and no party bonus', async () => {
        ...
        expect(stats.haste('Spell', 0)).to.eq(0);
        expect(stats.haste('Spell', 37)).to.eq(37);
        expect(stats.haste('Weaponskill', 37)).to.eq(37);
        expect(stats.haste('Auto-attack', 37)).to.eq(37);
